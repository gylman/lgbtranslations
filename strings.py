...
def emit_strings():
  d = {
    'finish-dialog-finished': {
      ...
      'az_Latn_AZ':'Babat! Axrıncı səviyyəni keçdin, möhtəşəm!',
    ...
    'finish-dialog-next': {
      ...
      'az_Latn_AZ':'Növbəti *"{nextLevel}"* səviyyəyə keçmək istəyirən?',
    ...
    'finish-dialog-win': {
      ...
      'az_Latn_AZ': 'Əla! Çözümümüzə uyğun gəldin, bəlkə də aşdın.',
